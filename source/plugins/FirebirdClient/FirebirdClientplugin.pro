...
RC_FILE = $$PWD/FirebirdClientplugin.rc
QMAKE_RC = rc -D_MSC_VER
include(FirebirdClientplugin.pri)
...
contains(QMAKE_HOST.os,Windows){
    contains(QMAKE_HOST.arch,x86_64){
        ...
        CONFIG(debug, debug|release) {
            ...
            TARGET = FirebirdClientplugin_x64d
        ...
        CONFIG(release, debug|release) {
            ...
            TARGET = FirebirdClientplugin_x64
        ...
        contains(QMAKE_HOST.arch,x86){
            ...
            CONFIG(debug, debug|release) {
                ...
                TARGET = FirebirdClientplugin_Win32d
            ...
            CONFIG(release, debug|release) {
                ...
                TARGET = FirebirdClientplugin_Win32
