...
Rectangle
{
	...
	This value is set to (600:800) but when running this file directly from StimulGL it's automatically maximized to full screen so the set value is ignored.
	...
	*/	
	...
	MouseArea //A Mouse Area item, that let's us capture mouse events
	{
		...
		onClicked: 
		{
			console.log("Mouse click detected...") 	//A way of sending text to the StimulGL Output Log Pane, used for debugging and testing purpose
