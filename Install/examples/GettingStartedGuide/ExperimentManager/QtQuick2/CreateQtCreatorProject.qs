...
function CreateQMLProject(Project_Name,QML_ProjectFilePath,QML_SourceFilePath)
{
	...
	var sData = "/* File generated by " + StimulGL.invokeJavaScriptConfigurationFile("StimulGLInfo.GetMainAppInternalName()") + " version (" + StimulGL.invokeJavaScriptConfigurationFile("StimulGLInfo.GetCurrentRelease()")+ ") */\n\n";
	...
	sData = sData + "\timportPaths: [ \"" + StimulGL.getQMLPluginPath() + "\" ]\n";
	sData = sData + "}\n";
...
//var itemArray = new Array("item1", "item2", "item3", "item4");
