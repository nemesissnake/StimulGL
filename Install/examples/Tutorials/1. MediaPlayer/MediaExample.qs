...
function ExperimentStructureChanged(nCurrentBlock,nCurrentTrial,nCurrentTrigger)
{
	...
	{
		MainItem = "functions";
		functionName = "setAndPlaySoundFunction";
		Param1 = SoundPathArray[nCurrentTrigger];
...
ExperimentManagerObj.setExperimentFileName(currentScriptLocation + "/MediaExample.exml"); //Set the experiment file
