...
////////////////////////
StimulGL.addOutputWindow("BasicRetinotopyExperiment");
StimulGL.clearOutputWindow("BasicRetinotopyExperiment");
...
BasicExperiment.__proto__.ConnectDisconnectScriptFunctions = _.compose(BasicExperiment.ConnectDisconnectScriptFunctions, function(Connect)
{
	...
	if(Connect)
	{
		...
		{
			StimulGL.write2OutputWindow(".*. Something went wrong connecting the Signal/Slots:" + e,"BasicRetinotopyExperiment");
		}		
	}
	else
	{
		...
		{
			StimulGL.write2OutputWindow(".*. Something went wrong disconnecting the Signal/Slots:" + e,"BasicRetinotopyExperiment");
		}		
	}
	return Connect;
})