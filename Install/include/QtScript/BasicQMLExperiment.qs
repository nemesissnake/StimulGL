...
////////////////////////
StimulGL.addOutputWindow("BasicQMLExperiment");
StimulGL.clearOutputWindow("BasicQMLExperiment");
...
BasicExperiment.__proto__.InvokeQMLFunction = function(sMainItemName, sFunctionName, vParam1, vParam2, vParam3, vParam4, vParam5, vParam6, vParam7, vParam8, vParam9)
{
	...
	if(BasicExperiment.sChoosenExperimenMode == "Testing_Mode")
	{
		...
		StimulGL.write2OutputWindow("\tReturned value by " + sFunctionName + "(" + sArguments + ") is: " + retVal + " >>>","BasicQMLExperiment");	
	}
}
...
BasicExperiment.__proto__.LogExperimentState = _.compose(BasicExperiment.LogExperimentState, function()
{
	...
	{	
		...
		StimulGL.write2OutputWindow("* " + "DebugMode_Functions:updateExperimentState" + " returned: " + retVal + " >>>", "BasicQMLExperiment");	
	}
...
BasicExperiment.__proto__.ConnectDisconnectScriptFunctions = _.compose(BasicExperiment.ConnectDisconnectScriptFunctions, function(Connect)
{
	...
	if(Connect)
	{
		...
		{
			StimulGL.write2OutputWindow(".*. Something went wrong connecting the Signal/Slots:" + e,"BasicQMLExperiment");
		}		
	}
	else
	{
		...
		{
			StimulGL.write2OutputWindow(".*. Something went wrong disconnecting the Signal/Slots:" + e,"BasicQMLExperiment");
		}		
	}
	return Connect;
})