...
RC_FILE = $$PWD/SerialPortDeviceplugin.rc
QMAKE_RC = rc -D_MSC_VER
include(SerialPortDeviceplugin.pri)
...
contains(QMAKE_HOST.os,Windows){
    contains(QMAKE_HOST.arch,x86_64){
        ...
        CONFIG(debug, debug|release) {
            ...
            TARGET = SerialPortDeviceplugin_x64d
        ...
        CONFIG(release, debug|release) {
            ...
            TARGET = SerialPortDeviceplugin_x64
        ...
        contains(QMAKE_HOST.arch,x86){
            ...
            CONFIG(debug, debug|release) {
                ...
                TARGET = SerialPortDeviceplugin_Win32d
            ...
            CONFIG(release, debug|release) {
                ...
                TARGET = SerialPortDeviceplugin_Win32
