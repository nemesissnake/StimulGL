...
RC_FILE = $$PWD/PiezoStimDeviceplugin.rc
QMAKE_RC = rc -D_MSC_VER
include(PiezoStimDeviceplugin.pri)
...
contains(QMAKE_HOST.os,Windows){
    contains(QMAKE_HOST.arch,x86_64){
        ...
        CONFIG(debug, debug|release) {
            ...
            TARGET = PiezoStimDeviceplugin_x64d
        ...
        CONFIG(release, debug|release) {
            ...
            TARGET = PiezoStimDeviceplugin_x64
        ...
        contains(QMAKE_HOST.arch,x86){
            ...
            CONFIG(debug, debug|release) {
                ...
                TARGET = PiezoStimDeviceplugin_Win32d
            ...
            CONFIG(release, debug|release) {
                ...
                TARGET = PiezoStimDeviceplugin_Win32
