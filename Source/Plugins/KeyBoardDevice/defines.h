...
#define PLUGIN_INTERNAL_NAME						"KeyBoardCapture"
#define PLUGIN_SCRIPTOBJECT_NAME					"KeyBoardCapture"
...
#define PLUGIN_FILE_DESCRIPTION						"Library that makes KeyBoard capturing possible"
