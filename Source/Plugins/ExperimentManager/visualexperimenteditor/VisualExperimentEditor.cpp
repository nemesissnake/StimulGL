...
VisualExperimentEditor::VisualExperimentEditor()
{
    ...
    //1234QWidget *widget = new QWidget;
    //1234widget->setLayout(layout);

    //1234setCentralWidget(widget);
	//1234setTitle(tr("Diagramscene"));
    //1234setUnifiedTitleAndToolBarOnMac(true);
}
...
void VisualExperimentEditor::backgroundButtonGroupClicked(QAbstractButton *button)
{
    ...
    if (text == tr("Blue Grid"))
        scene->setBackgroundBrush(QPixmap(":/visualexperimenteditor/images/background1.png"));
    else if (text == tr("White Grid"))
        scene->setBackgroundBrush(QPixmap(":/visualexperimenteditor/images/background2.png"));
    else if (text == tr("Gray Grid"))
        scene->setBackgroundBrush(QPixmap(":/visualexperimenteditor/images/background3.png"));
    else
        scene->setBackgroundBrush(QPixmap(":/visualexperimenteditor/images/background4.png"));
...
void VisualExperimentEditor::textColorChanged()
{
    ...
    fontColorToolButton->setIcon(createColorToolButtonIcon(
                                     ":/visualexperimenteditor/images/textpointer.png",
...
void VisualExperimentEditor::itemColorChanged()
{
    ...
    fillColorToolButton->setIcon(createColorToolButtonIcon(
                                     ":/visualexperimenteditor/images/floodfill.png",
...
void VisualExperimentEditor::lineColorChanged()
{
    ...
    lineColorToolButton->setIcon(createColorToolButtonIcon(
                                     ":/visualexperimenteditor/images/linecolor.png",
...
void VisualExperimentEditor::createToolBox()
{
    ...
    backgroundLayout->addWidget(createBackgroundCellWidget(tr("Blue Grid"),
                                                           ":/visualexperimenteditor/images/background1.png"), 0, 0);
    backgroundLayout->addWidget(createBackgroundCellWidget(tr("White Grid"),
                                                           ":/visualexperimenteditor/images/background2.png"), 0, 1);
    backgroundLayout->addWidget(createBackgroundCellWidget(tr("Gray Grid"),
                                                           ":/visualexperimenteditor/images/background3.png"), 1, 0);
    backgroundLayout->addWidget(createBackgroundCellWidget(tr("No Grid"),
                                                           ":/visualexperimenteditor/images/background4.png"), 1, 1);
...
{
    toFrontAction = new QAction(QIcon(":/visualexperimenteditor/images/bringtofront.png"),
