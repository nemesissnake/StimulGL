...
#define PLUGIN_MAIN_PROGRAM_MINIMAL_VERSION			"2.0.0.1"
#define PLUGIN_EXMLDOC_MINIMAL_VERSION_MAJOR		2
#define PLUGIN_EXMLDOC_MINIMAL_VERSION_MINOR		0
#define PLUGIN_EXMLDOC_MINIMAL_VERSION_REVISION		0
#define PLUGIN_EXMLDOC_MINIMAL_VERSION_BUILD		1
