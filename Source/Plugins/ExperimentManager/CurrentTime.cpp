...
static double highResUpTime()
{
    ...
    DWORD tickCount = (DWORD)GetTickCount64();// changed again back from --> timeGetTime();//changed on 10-09-13, should be more stable than GetTickCount(), see http://blogs.msdn.com/b/larryosterman/archive/2009/09/02/what-s-the-difference-between-gettickcount-and-timegettime.aspx;
...
double currentTime()
{
    ...
    // force a clock re-sync if we have drifted
