...
function InitVars(ExperimentRunName)
{
	...
	case "MovingBar1":
		...
		EmptyRandomList = new Array();
		MovingBarAngleList = new Array(0,45,90,135,180,225,270,315);
		MovingBarRandomIndexList = new Array(0,7,4,1,2,5,6,3,6,0,1,4,3,2,7,5,7,5,0,1,4,2,3,6);//MovingBar1
		//MovingBarRandomIndexList = new Array(1,2,7,5,3,0,6,4,3,1,4,2,0,5,7,6,0,7,1,4,3,5,6,2);//MovingBar2
