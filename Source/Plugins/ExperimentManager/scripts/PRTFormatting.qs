var PRTFormatManagerObj = new PRTFormatManager();
...
if(PRTFormatManagerObj.loadFile("E:\\Projects\\StimulGL\\Install\\prt_files\\SubjectName_Date_ExperimentName_run1.prt"))
{
	Log("loadFile() successfull");
}

if(PRTFormatManagerObj.saveFile("E:\\Projects\\StimulGL\\Install\\prt_files\\SubjectName_Date_ExperimentName_run1_new.prt", true))
{
