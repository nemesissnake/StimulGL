...
include(Retinotopic_Mappingplugin.pri)
...
contains(QMAKE_HOST.os,Windows){
    contains(QMAKE_HOST.arch,x86_64){
        ...
        CONFIG(debug, debug|release) {
            ...
            TARGET = Retinotopic_Mappingplugin_x64_Debug
        ...
        CONFIG(release, debug|release) {
            ...
            TARGET = Retinotopic_Mappingplugin_x64_Release
        ...
        contains(QMAKE_HOST.arch,x86){
            ...
            CONFIG(debug, debug|release) {
                ...
                TARGET = Retinotopic_Mappingplugin_Win32_Debug
            ...
            CONFIG(release, debug|release) {
                ...
                TARGET = Retinotopic_Mappingplugin_Win32_Release
