...
#define MAIN_PROGRAM_DOC_BINARYCOLLFILE					"main_documentation.qhc"
#define MAIN_PROGRAM_FILE_DESCRIPTION					"Open Source Cross Platform Scriptable Application"
#define MAIN_PROGRAM_FILESEXTENSION_LIST				"QT Script files (*.qs);;SVG files (*.svg *.svgz *.svg.gz);;Any files (*)"
